...
import Sistemadetrazabilidad ,{loader as nuevatrazabilidadLoader}  from "./views/Sistemadetrazabilidad";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "/trazabilidad/tostadero/",
        element: <Tostadero />,
        action:NewTostaderoAction
        
      },
      {
        path: "/trazabilidad/reposo",
        element: <Rest />,
        action: newRestAction,
      },
      {
        path: "/trazabilidad/analisis",
        element: <Analisis />,
        action:NewAnalisisAction
      },
      {
        path: "/trazabilidad/embalaje",
        element: <Embalaje />,
      },
    ],
  },
