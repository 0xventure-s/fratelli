...
import { ClipboardIcon, ClockIcon, CubeIcon } from "@heroicons/react/24/outline"; // Importa los íconos necesarios
          ...
          >
            ...
            {materia?.map((item) => (
              <option key={item.id} value={item.id}>
                Variedad: {item.variedad} - LR{item.id} - Kg Disponibles: {item.cantidad}
