    ...
    <>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-white shadow-sm p-4 rounded-lg text-center border border-gray-200">
          ...
          <p className="text-green-500 text-xs mt-1">+% desde el último mes</p>
        </div>
        ...
        <div className="bg-white shadow-sm p-4 rounded-lg text-center border border-gray-200">
          ...
          <p className="text-3xl font-semibold text-yellow-500">#</p>
          <p className="text-red-500 text-xs mt-1">- desde la semana pasada</p>
        </div>
        ...
        <div className="bg-white shadow-sm p-4 rounded-lg text-center border border-gray-200">
          ...
          <p className="text-green-500 text-xs mt-1">+ nuevos esta semana</p>
        </div>
      </div>
