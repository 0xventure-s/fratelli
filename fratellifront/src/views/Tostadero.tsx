...
import { ClockIcon, FireIcon, AdjustmentsHorizontalIcon, ListBulletIcon } from "@heroicons/react/24/outline";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div className="bg-white shadow-md rounded-lg p-5 border border-gray-200">
            <div className="flex items-center mb-3">
              ...
              <label className="text-gray-800 font-semibold" htmlFor="fechaHoraTostado">
                Fecha y Hora de Tueste
              </label>
            </div>
            <input
          ...
          <div className="bg-white shadow-md rounded-lg p-5 border border-gray-200">
            <div className="flex items-center mb-3">
              ...
              <label className="text-gray-800 font-semibold" htmlFor="tipoDeTostado">
                Tipo de Tueste
              </label>
            </div>
            <input
          ...
          <div className="bg-white shadow-md rounded-lg p-5 border border-gray-200">
            <div className="flex items-center mb-3">
              ...
              <label className="text-gray-800 font-semibold" htmlFor="temperatura">
                Temperatura
              </label>
            </div>
            <input
          ...
          <div className="bg-white shadow-md rounded-lg p-5 border border-gray-200 sm:col-span-2">
            <div className="flex items-center mb-3">
              <ClockIcon className="h-6 w-6 text-gray-800 mr-2" />
              <label className="text-gray-800 font-semibold" htmlFor="tiempoDeTostado">
